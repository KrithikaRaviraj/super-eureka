...
async function sendLoginSuccessEmail(user, req = {}) {
  ...
  const mailOptions = {
    ...
    html: buildEmailTemplate({
      ...
      contentHtml: `
        <p style="margin:0 0 18px 0;font-size:15px;line-height:1.7;color:#374151;">Hi <strong>${safeDisplayName}</strong>, your account was signed in successfully. If this was you, no action is required.</p>
