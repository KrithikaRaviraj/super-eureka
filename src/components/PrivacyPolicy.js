        ...
        <div className="p-6 space-y-6 text-stone-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-stone-50 p-4 rounded-lg mb-4">
              ...
              <p><strong>Email:</strong> <a href="mailto:lavishladiessalonuchila@gmail.com" className="text-rose-600 hover:text-rose-700">lavishladiessalonuchila@gmail.com</a></p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 mb-4">
              ...
              <p className="text-xs text-stone-600 italic">To exercise these rights, contact us at <a href="mailto:lavishladiessalonuchila@gmail.com" className="text-rose-600 hover:text-rose-700">lavishladiessalonuchila@gmail.com</a> with proper identification.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-stone-50 p-4 rounded-lg mb-4">
              ...
              <p><strong>Contact:</strong> <a href="mailto:lavishladiessalonuchila@gmail.com" className="text-rose-600 hover:text-rose-700">lavishladiessalonuchila@gmail.com</a></p>
