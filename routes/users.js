  ...
  try {
    ...
    const mailOptions = {
      ...
      html: buildEmailTemplate({
        ...
        contentHtml: `
          <p style="margin:0 0 18px 0;font-size:15px;line-height:1.7;color:#374151;">Hi ${name || 'there'}, this is a confirmation that your profile information was updated.</p>
